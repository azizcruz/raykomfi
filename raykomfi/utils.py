...
def write_into_instgram_image(text, text_size=0):
    try:
        # use a good font!
        fontFile = BASE_DIR + "/media/instgram/fonts/t.ttf"
    
        # this was a 400x400 jpg file
        imageFile = BASE_DIR + "/media/instgram/post_image.png"
        ...
        if text_size > 30:
            ...
            draw.text(((W-w)/1.7,(H-h)/2), bidi_text, (255,255,255), font=font, align='center')
        draw.text((200,750), bidi_text_fixed2, (255,255,0), font=font2, align='center')
        draw = ImageDraw.Draw(image)
        image = image.convert('RGB')
    
        # save it
        image.save(BASE_DIR + "/media/instgram/generated_post_image/output.jpg")
    except:
        print ('errpr here =====>')